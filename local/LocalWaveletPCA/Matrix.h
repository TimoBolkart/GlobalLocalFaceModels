...
//		_41 = m._41;	_42 = m._42;	_43 = m._43;	_44 = m._44;
	...
	C3Vector<scalar> operator*(const C3Vector<scalar>& v)
	{
	...
	//C4Vector<scalar> operator*(const C4Vector<scalar>& v)
	//{
	...
	void setTranslation(const C3Vector<scalar>& v)
	{
		_14 = v.x;
		_24 = v.y;
		_34 = v.z;
	...
	void setTranslationMatrix(const C3Vector<scalar>& v)
	{
		setIdentity();
		_14 = v.x;
		_24 = v.y;
	...
	void setScaleMatrix(scalar s)
	{
		setIdentity();
		_11 = _22 = _33 = s;
	}
	
	void setScaleMatrix(const C3Vector<scalar>& v)
	{
		setIdentity();
		_11 = v.x;
		_22 = v.y;
	...
	void setRotationAboutX(scalar radians)
	{
		setIdentity();
		_22 = cos(radians);
		_23 = -sin(radians);
	...
	void setRotationAboutY(scalar radians)
	{
		setIdentity();
		_11 = cos(radians);
		_13 = sin(radians);
	...
	void setRotationAboutZ(scalar radians)
	{
		setIdentity();
		_11 = cos(radians);
		_12 = -sin(radians);
	...
	void setRotation(const CQuaternion<scalar>& q)
	{
	...
	void setRotationMatrix(const CQuaternion<scalar>& q)
	{
		setIdentity();
		setRotation(q);
	}

	void getRotation(CQuaternion<scalar>& q)
	{
#if 0
	...
	void getNormalTransformNoScale(C4x4Matrix& matNorm)
	{
		matNorm = *this;
		matNorm._14 = matNorm._24 = matNorm._34 = 0.0;
	}
	void getNormalTransformUniScale(C4x4Matrix& matNorm)
	{
	...
	void getNormalTransformGeneral(C4x4Matrix& matNorm)
	{
		C3Vector<scalar> c1(_11, _21, _31), c1o;
		C3Vector<scalar> c2(_12, _22, _32), c2o;
		C3Vector<scalar> c3(_13, _23, _33), c3o;
	...
	void setLookAt(C3Vector<scalar>& eye, C3Vector<scalar>& at, C3Vector<scalar>& up)
	{
	...
	void setPerspectiveProjection(scalar width, scalar height, scalar centerX, scalar centerY, scalar nearZ, scalar farZ)
	{
		scalar rcpDiff;
		scalar rcpW, rcpH;
	...
	void setOrthographicProjection(scalar width, scalar height, scalar centerX, scalar centerY, scalar nearZ, scalar farZ)
	{
		scalar rcpDiff;
		scalar rcpW, rcpH;
	...
	void setPerspectiveProjection(scalar fieldOfView, scalar aspectRatio, scalar nearZ, scalar farZ)
	{
		scalar width, height;
