...
public:
	...
	void distanceStatsHistogram(NNAReal* pmean, NNAReal* pstd, NNAReal* pmin, NNAReal* pmax, int nBins, NNAReal* pBinDist, int *pBinCount);

	void distanceStatsHistogram(int nBins, char* szFilename);
};
