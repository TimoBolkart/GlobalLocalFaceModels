...
public:
	...
	static bool alignData(const std::vector<double>& modelData, const std::vector<double>& modelLandmarks, const std::vector<bool>& modelLandmarksLoaded, std::vector<double>& data, const std::vector<double>& dataLandmarks
								, const std::vector<bool>& dataLandmarksLoaded, double& s, std::vector<double>& R, std::vector<double>& t, bool bICPRefinement = true, bool bScaling = true);
	...
	static bool calcICPRefinenment(const std::vector<double>& modelData, const std::vector<double>& data, const double maxIPCPointDist, double& s, std::vector<double>& R, std::vector<double>& t, bool bScaling = true);
